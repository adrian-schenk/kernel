...
static inline struct cpu_features __get_cpu_features(void) {
    unsigned int unused, ebx, ecx, edx;
    __get_cpuid(1, &unused, &ebx, &ecx, &edx);
    struct cpu_features features = {ebx, ecx, edx};
    return features;
}

static inline int __get_cpu_model(void) {
    int ebx, unused;
    __cpuid(0, unused, ebx, unused, unused);
    return ebx;
}

static inline int __check_apic(void) {
