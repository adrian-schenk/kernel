...
extern interrupt_handler_t interrupt_handlers_ap[256];

void interrupts_setup();

void set_interrupt_handler(interrupt_handler_t *handlers, uint64_t interrupt_number, interrupt_handler_t);
